...
# Start downloading the "binaries of OS X":http://www.oracle.com/technology/software/products/database/oracle10g/htdocs/10204macsoft_x86-64.html.
...
{% endhighlight %}
# Trick the Oracle Installer to use localhost (useful if you use DHCP for your network configuration[4]):
{% highlight text %}
...
System altered.
{% endhighlight %}
# Make sure your @tnsnames.ora@[3] file contains the following:
{% highlight text %}
DEV =
  (DESCRIPTION =
