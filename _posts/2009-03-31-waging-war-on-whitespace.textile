...
fn4. There is one caveat: any bookmarks you've set will get blown away upon running "Remove Trailing Spaces in Document / Selection" command (which is run when you save).  This is an annoyance that I've learned to live with out of respect for my peers' diffs.
