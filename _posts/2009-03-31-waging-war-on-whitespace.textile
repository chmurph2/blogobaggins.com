...
p(meta). March 31, 2009 - Leesburg, VA
...
fn4. There is one caveat: any bookmarks you've set will get blown away upon save.  This is an annoyance that I've learned to live with out of respect for my peers' diffs.

fn5. I'm aware of the religious debate about tabs vs. spaces, but please, please use spaces instead of tabs.  Tabs cause even more diff cruft, and screws up the formatting in other editors. This isn't a problem if everyone instructs their editors to instead use spaces; the inverse is not true.