...
fn5. I'm aware of the religious debate about "tabs vs. spaces":http://www.jwz.org/doc/tabs-vs-spaces.html, but please, please use spaces instead of tabs.  Tabs cause even more diff cruft, and screws up the formatting in other editors. This isn't a problem if everyone instructs their editors to instead use spaces; the inverse is not true.