...
This pulls the URL out of the tab (i.e. the "front document"), picks the title out of the current tab, then assigns them both to the clipboard with a carriage return between them.  You can see the "gist":http://gist.github.com/70565 of it here as well. I actually like this approach better than the Copy URL extension in Firefox since I can now assign a hotkey to it, again using Quicksilver.
